...
jammin is a comprehensive toolkit that helps you spin up projects, build services, ship them to a network, and monitor what happens after deploy. This template uses the **Jade SDK** for building JAM services.
